...
for (const route of pages) {
  ...
  for (const icon of ["/favicon.ico", "/assets/favicon-32.png", "/assets/favicon-48.png", "/assets/favicon-96.png", "/assets/favicon.svg", "/apple-touch-icon.png"]) {
    assert.ok(html.includes(`href="${icon}?v=3"`), `${route}: expected icon ${icon}`);
  }
